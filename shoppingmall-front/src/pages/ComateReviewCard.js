...
const ComateReviewCard = ({
    ...
    rating, content, tags, 
    likeCount: initalLikeCount, likedByCurrentUser,
    ...
    const [likeCount, setLikeCount] = useState(initalLikeCount || 0);
    ...
    const handleLikeClick = async () => {
        try {
            ...
            if (onToggleLike) await onToggleLike(reviewNo, liked);
            await toggleLike(reviewNo, liked);
            ...
            <div className="review_info">
                ...
                <div className="review_content">{content}</div>
                    <div className="review_like_wrapper">
                        ...
                        fill={liked ? "red" : "none"} stroke="red" strokeWidth="2"
